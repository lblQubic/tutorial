...
from qubic.qcvv.gatesim.gatesim import *
...
#	popt,pcov=crfullxy.fit()
	...
	cnot=c_cnot(qubitid=qubitid,calirepo='submodules/qchip',debug=2)#,gmixs=None)
	cnot.runseqs(nsample=200)#,heraldcmds=None)
